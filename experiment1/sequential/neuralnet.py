...
# Prepare model
shape_models = [MLPClassifier(random_state = RANDOM_SEED, max_iter = 1000, learning_rate_init = 0.01) for _ in range(3)]
material_model = MLPClassifier(random_state = RANDOM_SEED, max_iter = 1000, learning_rate_init = 0.01)
